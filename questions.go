...
var difficulties = map[string]difficultyMeta{
	DiffKids: {
		...
		Questions: []Question{
			...
			{
				Text:    "Kylian Mbappé, a superstar striker, plays for which country?",
				Options: []string{"France", "Spain", "Brazil", "England"},
				Answer:  0,
				Fact:    "France's number 10 — and one of the fastest players in the world.",
			},
			{
				Text:    "Erling Haaland scores lots and lots of goals for which country?",
				Options: []string{"Sweden", "Norway", "Denmark", "Iceland"},
				Answer:  1,
				Fact:    "Norway! He's famous for scoring goals by the bucketload.",
			},
			{
				Text:    "The Netherlands team is famous for wearing which bright colour?",
				Options: []string{"Orange", "Purple", "Pink", "Grey"},
				Answer:  0,
				Fact:    "Bright orange — fans call the team the \"Oranje\".",
			},
			{
				Text:    "Which country does the famous player Neymar play for?",
				Options: []string{"Portugal", "Spain", "Brazil", "Mexico"},
				Answer:  2,
				Fact:    "Neymar is one of Brazil's biggest superstars.",
			},
			{
				Text:    "Argentina, the team of Lionel Messi, wears shirts of which two colours?",
				Options: []string{"Light blue and white", "Red and black", "Green and yellow", "All black"},
				Answer:  0,
				Fact:    "Argentina's famous light-blue-and-white stripes.",
			},
			{
				Text:    "How many times has Germany won the World Cup — none or lots?",
				Options: []string{"Never", "Once", "Four times", "Twenty times"},
				Answer:  2,
				Fact:    "Germany are four-time world champions!",
			},
		},
	},
	DiffAdult: {
		...
		Questions: []Question{
			...
			{
				Text:    "Since 2024, Kylian Mbappé plays his club football for which team?",
				Options: []string{"Paris Saint-Germain", "Real Madrid", "Liverpool", "Al-Nassr"},
				Answer:  1,
				Fact:    "He joined Real Madrid from Paris Saint-Germain in 2024.",
			},
			{
				Text:    "Italy's national team is nicknamed the what?",
				Options: []string{"Azzurri", "Oranje", "Les Bleus", "Seleção"},
				Answer:  0,
				Fact:    "\"Gli Azzurri\" — the Blues — after their sky-blue shirts.",
			},
			{
				Text:    "Harry Kane, England's record goalscorer, plays his club football for which team?",
				Options: []string{"Tottenham", "Bayern Munich", "Manchester United", "Chelsea"},
				Answer:  1,
				Fact:    "He joined Bayern Munich from Tottenham in 2023.",
			},
		},
	},
	DiffNerd: {
		...
		Questions: []Question{
			...
			{
				Text:    "Which nation became the first African team to reach a World Cup semi-final, in 2022?",
				Options: []string{"Senegal", "Morocco", "Cameroon", "Ghana"},
				Answer:  1,
				Fact:    "Morocco beat Spain and Portugal on the way to the semi-finals.",
			},
			{
				Text:    "Who is Brazil's all-time leading World Cup goalscorer, with 15 goals?",
				Options: []string{"Pelé", "Ronaldo (Nazário)", "Romário", "Neymar"},
				Answer:  1,
				Fact:    "Ronaldo \"O Fenômeno\" scored 15 World Cup goals for Brazil.",
			},
			{
				Text:    "Which goalkeeper captained Spain to the 2010 World Cup title?",
				Options: []string{"Iker Casillas", "Víctor Valdés", "Pepe Reina", "David de Gea"},
				Answer:  0,
				Fact:    "Iker Casillas lifted the trophy as both captain and goalkeeper.",
			},
		},
	},
}
